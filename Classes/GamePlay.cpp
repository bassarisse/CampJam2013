...
//            Shadow* sh = Shadow::create();
//            sh->setPosition(plinit->getNode()->getPosition());
//            sh->setContentSize(ccp(100,100));
//            _mainLayer->addChild(sh);
...
void Shadow::draw() {
	...
	ccDrawLine( this->convertToWorldSpace(this->getPosition()), ccp(s.width, s.height) );
